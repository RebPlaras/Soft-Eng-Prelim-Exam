...
<nav class="bg-purple-700 p-4">
  <div class="container mx-auto flex justify-between items-center">
    <a class="text-white text-xl font-bold" href="index.php">Client Panel</a>
    <div class="hidden md:flex space-x-4">
      <a class="text-white hover:text-purple-200" href="project_offers_submitted.php">Project Offers Submitted</a>
