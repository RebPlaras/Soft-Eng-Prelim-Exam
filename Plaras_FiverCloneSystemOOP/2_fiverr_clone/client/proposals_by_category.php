...
$proposals = $proposalObj->getProposalsByCategoryId($_GET['id']);
?>
<!doctype html>
  <html lang="en">
  <head>
    ...
    <title>Proposals by Category</title>
  </head>
  <body class="bg-gray-100">
    <?php include 'includes/navbar.php'; ?>
    <div class="container mx-auto px-4 py-8">
        <h1 class="text-3xl font-bold text-purple-700 text-center mb-8">Proposals in <?php echo $proposals[0]['category_name'] ?? 'Category'; ?></h1>
