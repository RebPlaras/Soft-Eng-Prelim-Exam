...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8 flex justify-center items-center min-h-screen">
        <div class="bg-white shadow-md rounded-xl p-8 w-full max-w-md">
            <h1 class="text-3xl font-bold text-purple-700 text-center mb-8">Freelancer Login</h1>
            <?php  
            ...
            <form action="core/handleForms.php" method="POST" class="space-y-4">
                ...
                <button type="submit" name="loginUserBtn" class="w-full bg-purple-600 text-white py-2 px-4 rounded-lg hover:bg-purple-700 transition">Login</button>
            </form>
            <p class="text-center mt-4">Don't have an account? <a href="register.php" class="text-purple-600 hover:underline">Register here</a></p>
        </div>
    </div>
</body>
</html>