                ...
                <div class="w-full max-w-md">
                    <div class="bg-white shadow-lg rounded-xl border border-primary-100">
                        <div class="gradient-bg text-white text-center py-4 px-6 rounded-t-xl">
                            <h2 class="text-2xl font-bold">Writer Login</h2>
                        </div>
                        <div class="p-8">
                            <?php  
                            ...
                            <form action="core/handleForms.php" method="POST">
                                ...
                                <div class="mb-6">
                                    ...
                                    <input type="password" class="shadow-sm appearance-none border border-gray-300 rounded w-full py-3 px-4 text-gray-700 mb-3 leading-tight focus:outline-none focus:ring-2 focus:ring-primary-500" name="password" required>
                                </div>
                                <div class="flex items-center justify-between">
                                    <button type="submit" class="gradient-bg hover:bg-primary-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline w-full" name="loginUserBtn">Login</button>
                                </div>
                            </form>
                            <div class="text-center mt-6">
                                <p class="text-gray-600">Don't have an account yet? <a href="register.php" class="text-primary-600 hover:text-primary-800 font-semibold">Register here!</a></p>
                            </div>
                        </div>
                    </div>
                </div>
